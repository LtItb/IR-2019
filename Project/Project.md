...
<p style='text-align: justify;'> В данном частном техническом задании описана реализация веб-приложения – поисковой системы по базе фильмов. 
...
Ниже приведено обоснование выбора средств разработки и платформы, а также более подробно описана реализация функций приложения. </p>
