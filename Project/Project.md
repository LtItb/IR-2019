...
![Рисунок 1 – Примерное расположение элементов на странице поиска]()
...
![Рисунок 2 – Пример модального окна с подробной информацией о фильме]()
...
![Рисунок 3 – Пример расположения элементов на вкладке добавления фильма в список спонсируемых]()
...
| :----------: | :---------------: | :---------------------------------------------: |
| ПК           | Windows 7         | Internet Explorer 11, Google Chrome 72 или выше |
| &#xfeff;     | Windows 8.1       | Internet Explorer 11, Google Chrome 72 или выше |
| &#xfeff;     | Windows 10        | Internet Explorer 11, Google Chrome 72 или выше |
