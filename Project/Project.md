...
Для реализации проекта выбрана система полнотекстового поиска Solr. Рекомендуется Solr 8.1. 
[Инструкция по установке Solr](https://tecadmin.net/install-apache-solr-on-ubuntu/) (инструкция для версии 7.5, но шаги те же).
...
1) указание слов и их позиций в полях документа:
...
2) указание расстояния между искомыми словами:
...
### 6.2. Требования Apache Solr 8.1
...
| Жесткий диск        | 20 GB + объем данных в БД |
